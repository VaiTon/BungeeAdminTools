...
public class MuteCommand extends CommandHandler {
	...
	public static void handleMuteCommand(final BATCommand command, final boolean global, final boolean ipMute,
		...
		checkArgument(!PermissionManager.isExemptFrom(Action.MUTE, target), I18n.getFormatted("isExempt"));

		checkArgument(!mute.isMute((ip == null) ? target : ip, server, false), I18n.getFormatted("alreadyMute"));
	...
	public static void handleUnmuteCommand(final BATCommand command, final boolean global, final boolean ipUnmute,
		...
		checkArgument(
				...
				(IModule.ANY_SERVER.equals(server) ? I18n.getFormatted("notMutedAny", formatArgs) : ((ipUnmute) ? I18n.getFormatted("notMutedIP",
						formatArgs) : I18n.getFormatted("notMuted", formatArgs))));
